...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '/home/nick/dNAO/notdnethack/web/dist/dnethack.data';
      var REMOTE_PACKAGE_BASE = 'dnethack.data';
...
Module['FS_createPath']("/", "notdnethackdir", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/home/nick/dNAO/notdnethack/web/dist/dnethack.data');

      };
      Module['addRunDependency']('datafile_/home/nick/dNAO/notdnethack/web/dist/dnethack.data');
    ...
    loadPackage({"files": [{"filename": "/notdnethackdir/license", "start": 0, "end": 4875}, {"filename": "/notdnethackdir/livelog", "start": 4875, "end": 4875}, {"filename": "/notdnethackdir/logfile", "start": 4875, "end": 4875}, {"filename": "/notdnethackdir/nhdat", "start": 4875, "end": 2085890}, {"filename": "/notdnethackdir/perm", "start": 2085890, "end": 2085890}, {"filename": "/notdnethackdir/record", "start": 2085890, "end": 2085890}, {"filename": "/notdnethackdir/xlogfile", "start": 2085890, "end": 2085890}], "remote_package_size": 2085890});
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        var pthreadMainJs = locateFile('dnethack.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(13, 1, dirfd, path, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(15, 1, __environ, environ_buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(16, 1, penviron_count, penviron_buf_size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(18, 1, fd, pbuf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 0, atomicIndex);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 1, fd,offset_low, offset_high,whence,newOffset);
